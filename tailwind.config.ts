  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-qled": {
          "0%, 100%": {
            boxShadow: "0 0 5px rgba(255, 100, 100, 0.3), 0 0 10px rgba(255, 100, 100, 0.2)",
          },
          "50%": {
            boxShadow: "0 0 10px rgba(255, 100, 100, 0.5), 0 0 20px rgba(255, 100, 100, 0.3)",
          },
        },
      },
      animation: {
        ...
        "flash-dot": "flash-dot 1.5s infinite",
        "pulse-qled": "pulse-qled 2s infinite",
      },
      backgroundImage: {
        "mono-grid":
        ...
        "deep-qled": "radial-gradient(circle at center, #080808 0%, #000000 100%)",
      },
    },
  },
